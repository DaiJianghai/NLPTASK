...
roberta_path = r'E:\Huggingface_Model\BERT\bert-base-chinese'
...
dataset = CLUEDataset(r'D:\DevelopmentProgress\Project_VSCode\deeplearning\src\task\IE\Pipleline\NER\Bert+LSTM+CRF\pytorch-NER\clue\train.json', model.tokenizer)
dataloader_train = DataLoader(dataset, collate_fn=dataset.collate_fn,
                              batch_size=batch_size, shuffle=True, drop_last=True)
dataset = CLUEDataset(r'D:\DevelopmentProgress\Project_VSCode\deeplearning\src\task\IE\Pipleline\NER\Bert+LSTM+CRF\pytorch-NER\clue\dev.json', model.tokenizer)
